...
export const InputSearch = () => {
  ...
  return (
    <div
      className="bg-white dark:bg-dark-100 rounded-[20px] w-[750px] flex items-center py-0 px-[15px]
    ...
    >
      ...
      <form className="w-full" onSubmit={handleSubmit}>
        <input
          type="search"
          id="search"
          className="w-full bg-transparent p-[10px] text-slate-700 dark:text-white/90
